...
public class edit extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        productDao.UpdateProduct(Integer.parseInt(id), ten,anh, Integer.parseInt(gia), mota);
        ...
        productDao.UpdateDetail(Integer.parseInt(id), manhinh, cpu, ram, ocung, dohoa, trongluong, kichthuoc);
