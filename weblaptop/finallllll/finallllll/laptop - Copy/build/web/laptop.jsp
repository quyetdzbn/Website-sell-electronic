        ...
        <div class="khung">
            <div class="ttruot">
                ...
                <div class="tieude-ttruot">   
                    <div class="bieutuong">
                        <a href="home" class="bieutuong-kn">NVT</a>
                    </div>
                    ...
                    <div class="khung-timkiem">
                        <form action="searchLap" method="post">
            ...
            <div class="noidung">
                <div class="tl-sanpham dong">
                    ...
                    <a href="laptop.jsp" class="cot l6 m6 c12">
                ...
                <div class="nd-sanpham dong">
                    <c:forEach items="${sessionScope.newlaptop}" var="n">
                ...
                <ul class="phanloai">
                    <li class="phanloai-sp ${tag==0? "active":""}">
                        <a class="mauchu" href="laptop.jsp">
                            Tất cả sản phẩm
                        </a>
                    </li>
                   
                    <c:forEach items="${sessionScope.typeOfLaptop}" var="t">
                    <li class="phanloai-sp ${tag==t.id? "active":""}">
                        <a class="mauchu" href="categoryLaptop?cID=${t.id}">
                            ${t.name}
                        </a>
