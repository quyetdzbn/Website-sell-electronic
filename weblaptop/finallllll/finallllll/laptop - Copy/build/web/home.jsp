        ...
        <div class="khung">
            <div class="ttruot">
                ...
                <div class="tieude-ttruot">   
                    <div class="bieutuong">
                        <a href="home" class="bieutuong-kn">NVQ</a>
                    </div>
                    ...
                    <div>
                        <ul class="thanhcongcu">
                            ...
                            <li class="congcu"><a href="quanlydonhang" class="kn">QL ĐƠN HÀNG</a></li>
                            </c:if>
            ...
            <div class="noidung">
                <div class="tl-sanpham dong">
                    ...
                    <a href="phukien" class="cot l6 m6 c12">
...
<!--                    <a href="" class="trend col l4 m4 c12">
                    ...
                    <c:forEach items="${newProduct}" var="n">
                        <div class="sanpham cot l3 m4 c12">
                            ...
                            <div class="chan-sp">
                                ...
                                <a href="cart?pid=${n.id}" class="them">Thêm vào giỏ hàng</a>
                                <!--<a class="them" href="cart?pid=">Thêm vào giỏ hàng</a>-->
                            </div>
                ...
                <ul class="phanloai">
                    ...
                    <li class="phanloai-sp ${tag==t.id? "active":""}">
                        <a class="mauchu" href="category?kind=${t.id}">
                            ${t.name}
                        </a>
                ...
                <div class="pagination">
                    <c:if test="${tag<1}">
                        <c:forEach begin="1" end="${endP}" var="i">
                            <a href="home?index=${i}&&kind=${tag}" class="${tagpage==i? "active":""}">${i}</a>
                        </c:forEach> 
                    </c:if>   
                    <c:if test="${tag>=1}">
                        <c:forEach begin="1" end="${endP}" var="i">
                            <a href="category?index=${i}&&kind=${tag}" class="${tagpage==i? "active":""}">${i}</a>
                        </c:forEach> 
                    </c:if>   
                </div>
            </div>
